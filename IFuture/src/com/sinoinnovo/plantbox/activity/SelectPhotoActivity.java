...
public class SelectPhotoActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		buttonPublish.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				//判断是否添加图片
				if(imageItem.size()==1) {
					Toast.makeText(SelectPhotoActivity.this, "没有图片需要上传", Toast.LENGTH_SHORT).show();
					return;
				}

				//消息提示
				Toast.makeText(SelectPhotoActivity.this, "发布成功", Toast.LENGTH_SHORT).show();
			}
		});
	...
	protected void DeleteDialog(final int position) {
		AlertDialog.Builder builder = new Builder(SelectPhotoActivity.this);
