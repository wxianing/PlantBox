...
public class DActionSheetDialog {
    ...
    public DActionSheetDialog(Context context) {
        this.context = context;
        WindowManager windowManager = (WindowManager) context.getSystemService(Context.WINDOW_SERVICE);
        display = windowManager.getDefaultDisplay();
    }

    public DActionSheetDialog builder() {
        // 获取Dialog布局
        View view = LayoutInflater.from(context)
                .inflate(R.layout.view_actionsheet, null);
        ...
        // 定义Dialog布局和参数
        dialog = new Dialog(context, R.style.DActionSheetDialogStyle);
    ...
    public DActionSheetDialog setTitle(String title) {
        showTitle = true;
    ...
    public DActionSheetDialog setCancelable(boolean cancel) {
        dialog.setCancelable(cancel);
        return this;
    }

    public DActionSheetDialog setCanceledOnTouchOutside(boolean cancel) {
     ...
     * @return
     */
    public DActionSheetDialog addSheetItem(String strItem,
