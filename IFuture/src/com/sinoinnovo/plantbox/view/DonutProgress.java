...
import com.sinoinnovo.plantbox.utils.DisplayUtils;
...
public class DonutProgress extends View {
    ...
    public DonutProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = DisplayUtils.sp2px(getResources(), 18);
        min_size = (int) DisplayUtils.dp2px(getResources(), 100);
        default_stroke_width = DisplayUtils.dp2px(getResources(), 5);
